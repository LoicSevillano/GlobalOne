...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,_In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR    lpCmdLine,_In_ int       nCmdShow)
{
    ...
    UpdateWindow(hWnd);
    theApp = new CGlobalOneApp(hInstance, hWnd, L"DRIVER={PostgreSQL Unicode};DATABASE=Loic;SERVER=localhost;UID=postgres;PWD=z4T1H9J69!;ByteaAsLongVarBinary=1");
    GetWindowRect(hWnd, &r);
    theApp->m_fenetreFormulaire.Create(hInst, WS_CHILDWINDOW, hWnd, 100, 0, r.right - r.left - 100, r.bottom - r.top);
    ShowWindow(theApp->m_fenetreFormulaire.GethWnd(), SW_SHOW);
